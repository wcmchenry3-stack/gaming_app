...
with_node \
  ...
  --target "/Users/bill.mchenry/gaming_app/frontend/ios/Pods/Target Support Files/Pods-GamingApp/ExpoModulesProvider.swift" \
  --entitlement "/Users/bill.mchenry/gaming_app/frontend/ios/GamingApp/GamingApp.entitlements" \
   \
  --platform "apple" \
  --packages "@expo/dom-webview" "expo" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-localization"
