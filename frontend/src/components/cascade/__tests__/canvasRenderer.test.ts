 ...
 *
 * Rendering behaviour is now verified via the CascadeScreen integration
 * tests (CascadeScreen.test.tsx), which mount the full component tree and
...
describe("fruit rendering (Skia)", () => {
  it("rendering is covered by CascadeScreen integration tests", () => {
