...
export default function Scorecard({
  ...
  function renderScoreRow(key: string, tone: "upper" | "lower") {
    return (
      <ScoreRow
        key={key}
        category={key}
  ...
  const activeColor = activeTab === "upper" ? colors.accent : colors.secondary;
  ...
  return (
    ...
    >
      <View style={[styles.tabBar, { borderBottomColor: colors.border }]} accessibilityRole="tablist">
